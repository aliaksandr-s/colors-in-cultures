...
var G__19665_19667 = tag;
var G__19666_19668 = goog.dom.createTextNode("");
goog.dom.appendChild(G__19665_19667,G__19666_19668);
...
if(cljs.core.truth_((function (){var fexpr__19669 = cljs.core.deref(self__.cache);
return (fexpr__19669.cljs$core$IFn$_invoke$arity$1 ? fexpr__19669.cljs$core$IFn$_invoke$arity$1(cls_name) : fexpr__19669.call(null,cls_name));
})())){
return null;
} else {
...
var rules_count = (function (){var G__19670 = goog.object.get(self__.sheet,"cssRules");
var G__19671 = "length";
return goog.object.get(G__19670,G__19671);
})();
if(cljss.utils.dev_QMARK_){
var G__19672 = self__.tag;
var G__19673 = goog.dom.createTextNode(rule__$1);
return goog.dom.appendChild(G__19672,G__19673);
} else {
try{return self__.sheet.insertRule(rule__$1,rules_count);
}catch (e19674){var e = e19674;
if(cljss.utils.dev_QMARK_){
